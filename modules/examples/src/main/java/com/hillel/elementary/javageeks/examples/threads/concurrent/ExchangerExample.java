...
public class ExchangerExample {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        new Thread(new Delivery.Truck(1, "A", "D", p1, exchanger)).start();//Отправляем 1-й грузовик из А в D
        Thread.sleep(100);
        new Thread(new Delivery.Truck(2, "B", "C", p2, exchanger)).start();//Отправляем 2-й грузовик из В в С
    }
}
